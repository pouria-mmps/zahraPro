    ...
    <div class="box-updateProduct">
        <form class="frm-product-crud" id="frm-product-crud" action="<?= baseUrl() ?>page/activeProduct" method="post">
            ...
            <input type="text" class="frm-perfume-name" name="perfumeName" value="<?= $perfume['perfumeName'] ?>"
                   style="text-align: center;margin-bottom: 60px;" disabled>
            <br>
            ...
            <input type="text" class="frm-structrue-smell" name="structrueSmell"
                   value="<?= $perfume['structrueSmell'] ?>" style="text-align: center;" disabled>
            <br><br><br>
            ...
            <textarea class="frm-breif" name="breif" style="margin-top:10px;"
                      disabled><?= $perfume['breif'] ?></textarea>
            <br><br><br>

            <label class="frm-txt" style="margin-bottom: -135px;">نقد و بررسی</label>
            <textarea class="frm-discription" name="discription" style="margin-top:10px;"
                      disabled><?= $perfume['discription'] ?></textarea>
            <br><br><br>
